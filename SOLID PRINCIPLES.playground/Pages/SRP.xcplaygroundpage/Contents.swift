...
/*:
 * Let's imagine we decide to change our persistence to core data, or parse, or both
 ...
 * So, the save functionality is a responsibility in the Book1 class that's an axis of change
